...
def _run_legacy_blueprint_scan(target_path: Path, is_json: bool, output_file: Optional[str]) -> None:
    ...
    _render_rich_blueprint_report(blueprint)


def _render_rich_blueprint_report(blueprint: Blueprint) -> None:
    """Renders the Software X-Ray blueprint report using Rich."""
    console.print()
