...
class Finding(BaseModel):
    ...
    rule_id: str = Field(description="Rule identifier, e.g. ARC001")
...
class HealthScore(BaseModel):
    """Software health score and multidimensional ratings."""
...
class RiskAssessment(BaseModel):
    ...
    risk_level: str = Field(default="NONE", description="LOW, MEDIUM, HIGH, or CRITICAL overall risk")
